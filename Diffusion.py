...
class GaussianDiffusion:
        ...
        for num in range(generat_imgs_num):
            ...
            for i in range(imgs.shape[0]):
                ...
                dirPath = os.path.join("generate_imgs",
                                       dataset_name,
                                       timestr,
                                       model_name+f"_ddim_{ddim_timesteps}",
                                       )
    ...
    def ddim_sample(
        ...
        for i in reversed(range(0, ddim_timesteps)):
            ...
            # prev_t = torch.full((batch_size,), ddim_timestep_seq[i]-1000//ddim_timesteps, device=device, dtype=torch.long)
            ...
            pred_noise = model(img_stack,fd,sample_img, t)
